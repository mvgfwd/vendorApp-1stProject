...
export class ButtonComponent implements OnInit{
    ...
    @Input() round: 'small' | 'medium' | 'large' | 'extra' | 'full' | 'extra-large' | undefined = 'medium';
    ...
    setSize(): void{
      ...
      setColor(): void {
        switch(this.color) {
          case 'primary': {
            this.colorClass = "bg-green-600 border-2 border-green-600 hover:bg-green-100 hover:text-green-600 ";
            this.heroStyle = " text-white "
            break;
          }
          case 'secondary': {
            this.colorClass = " bg-blue-500 border-2 border-blue-500 hover:bg-blue-200 hover:text-slate-700 ";
            this.heroStyle = " text-white "
            break;
          }
          case 'warning': {
            this.colorClass = " bg-yellow-500 border-2 border-yellow-500 hover:bg-yellow-100 font-jakarta hover:text-yellow-600 hover:border-yellow-500 ";
            this.heroStyle = " text-black "
            break;
          }
          case 'error': {
            this.colorClass = " bg-red-600 border-2 border-red-600 hover:bg-red-200 hover:text-red-700 hover:border-red-500";
            this.heroStyle = " text-white "
            break;
          }
          case 'success': {
            this.colorClass = "bg-white border-2 border-slate-500 hover:border-blue-500 hover:text-blue-600 hover:bg-blue-100";
            this.heroStyle = " text-slate-800 "
            break;
          }
          default: {
